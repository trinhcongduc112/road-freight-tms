...
// Master data ít đổi (vài lần/ngày) → TTL 60s an toàn. Mọi write tự invalidate resource.
masterDataRouter.use(invalidateAfterWrite("master-data"));

/* ── CUSTOMER ── */
masterDataRouter.get("/customers", cacheMiddleware(60), asyncHandler(ctrl.listCustomers));
masterDataRouter.get("/customers/:id", cacheMiddleware(60), asyncHandler(ctrl.getCustomer));
...
/* ── PRODUCT ── */
masterDataRouter.get("/products", cacheMiddleware(60), asyncHandler(ctrl.listProducts));
masterDataRouter.get("/products/:id", cacheMiddleware(60), asyncHandler(ctrl.getProduct));
...
/* ── VEHICLE ── */
masterDataRouter.get("/vehicles", cacheMiddleware(60), asyncHandler(ctrl.listVehicles));
masterDataRouter.get("/vehicles/:id", cacheMiddleware(60), asyncHandler(ctrl.getVehicle));
...
/* ── DRIVER ── */
masterDataRouter.get("/drivers", cacheMiddleware(60), asyncHandler(ctrl.listDrivers));
masterDataRouter.get("/drivers/:id", cacheMiddleware(60), asyncHandler(ctrl.getDriver));
...
/* ── SERVICE ── */
masterDataRouter.get("/services", cacheMiddleware(120), asyncHandler(ctrl.listServices));
masterDataRouter.get("/services/:id", cacheMiddleware(120), asyncHandler(ctrl.getService));
